...
class FirstNN(object):
    ...
    def optimizer(self, grads,update_rule='gd'):
        ...
        if update_rule=='gd':    
            ...
            self
        elif update_rule =='ns_gd':
            V_W1_prev = self.params['V_W1']
            V_b1_prev = self.params['V_b1']
            V_W2_prev = self.params['V_W2']
            V_b2_prev = self.params['V_b2']

            # Update velocity based on gradients
            self.params['V_W1'] = self.beta_moment * self.params['V_W1'] - self.learning_rate * grads['W1']
            self.params['V_b1'] = self.beta_moment * self.params['V_b1'] - self.learning_rate * grads['b1']
            self.params['V_W2'] = self.beta_moment * self.params['V_W2'] - self.learning_rate * grads['W2']
            self.params['V_b2'] = self.beta_moment * self.params['V_b2'] - self.learning_rate * grads['b2']

            # Nesterov update: apply "look ahead" step
            self.params['W1'] += -self.beta_moment * V_W1_prev + (1 + self.beta_moment) * self.params['V_W1']
            self.params['b1'] += -self.beta_moment * V_b1_prev + (1 + self.beta_moment) * self.params['V_b1']
            self.params['W2'] += -self.beta_moment * V_W2_prev + (1 + self.beta_moment) * self.params['V_W2']
            self.params['b2'] += -self.beta_moment * V_b2_prev + (1 + self.beta_moment) * self.params['V_b2']
            ...
            # # Update using the lookahead gradient
            # self.params['V_W1'] = self.beta_moment * self.params['V_W1'] - self.learning_rate * grads['W1'](W1_ahead)
            # self.params['W1'] += self.params['V_W1']
            # self.params['V_b1'] = self.beta_moment * self.params['V_b1'] - self.learning_rate * grads['b1'](b1_ahead)
            # self.params['b1'] += self.params['V_b1']
            # self.params['V_W2'] = self.beta_moment * self.params['V_W2'] - self.learning_rate * grads['W2'](W2_ahead)
            # self.params['W2'] += self.params['V_W2']
            # self.params['V_b2'] = self.beta_moment * self.params['V_b2'] - self.learning_rate * grads['b2'](b2_ahead)
